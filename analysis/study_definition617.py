...
study = StudyDefinition(
   ...
   # STUDY POPULATION - registered 1 year prior to November 16th 2020
    ...
    dereg_date=patients.date_deregistered_from_all_supported_practices(
        on_or_after="2021-04-07", date_format="YYYY-MM",
    ),
    ...
    covid_admission_date=patients.admitted_to_hospital(
        ...
        find_first_match_in_period=True,  
        date_format="YYYY-MM-DD",  
        return_expectations={"date": {"earliest": "2021-04-07"}, "incidence" : 0.3},
    ),
    ...
    creatinine=patients.with_these_clinical_events(
        ...
        return_expectations={
            ...
            "date": {"earliest": "2019-04-07", "latest": "2021-04-07"},
            "incidence": 0.95,
        },
    ),
