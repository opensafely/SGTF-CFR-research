...
*					vs. non-VOC for death given days spent in ICU
*  
********************************************************************************

* Open a log file
cap log close
log using ./logs/an_cox_hosp_icu, replace t
...
noi di "SUBSETTING ON DAYS IN ICU POPULATION"
keep if icu_pop == 1
...
file open tablecontent using ./output/table2_hr_hosp_icu.txt, write text replace
...
graph export ./output/cox_shoen_hosp_icu.svg, as(svg) replace
...
graph export ./output/cox_haz_hosp_icu.svg, as(svg) replace
...
insheet using ./output/table2_hr_hosp_icu.txt, clear
export excel using ./output/table2_hr_hosp_icu.xlsx, replace
