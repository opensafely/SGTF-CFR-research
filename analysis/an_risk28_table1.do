...
*	Data created:	
*
*	Other output:	Table 1 28-day risk study population
*
********************************************************************************
*
...
* Open a log file
cap log close
log using ./logs/an_risk28_table1, replace t
...
*file open tablecontent using "C:\Users\EIDEDGRI\Documents\GitHub\SGTF-CFR-research\output\table1_risk28.txt", write text replace
...
insheet using ./output/table1_risk28.txt, clear

export excel using ./output/table1_risk28.xlsx, replace
