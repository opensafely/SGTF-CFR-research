...
* Open a log file
cap log close
log using ./logs/cr_imputed_hosp, replace t
...
egen inc = rowmiss(age1 age2 age3 male obese4cat smoke_nomiss imd comorb_cat region ///
					rural_urban hh_total_cat home_bin sgtf start_week end_hosp_test)
...
mi impute logit eth2				///
			...
			i.sgtf					///
			i.start_week			///
			end_hosp_test, add(10) rseed(13072021) noisily iter(20)
			
			


label data "SGTF CFR HOSPTIAL ADMISSION IMPUTED DATASET: $S_DATE"

save ./output/cr_imputed_hosp.dta, replace
