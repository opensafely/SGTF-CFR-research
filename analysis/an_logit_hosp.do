...
table agegroup6 sgtf if e(sample)==1, contents(count patient_id) by(comorb_cat male)
table male comorb_cat if e(sample)==1

* Adjusted absolute risks
margins comorb_cat#male#agegroup6 if sgtf==0, post asobserved
...
* Adjusted absolute risks
margins comorb_cat#male#agegroup6 if sgtf==1, post asobserved
...
margins comorb_cat#male#agegroup6, dydx(sgtf) post asobserved
...
gen risk_labels = "Female: 0-<40" in 1
...
replace risk_labels = "Male: 0-<40" in 7
...
replace risk_labels = "Female: 0-<40" in 13
...
replace risk_labels = "Male: 0-<40" in 19
...
replace risk_labels = "Female: 0-<40" in 25
...
replace risk_labels = "Male: 0-<40" in 31
